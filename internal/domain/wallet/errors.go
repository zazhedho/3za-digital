...
var (
	...
	ErrQRISStaticImageUnavailable  = errors.New("static qris image url is not configured")
	ErrDepositCancelReasonRequired = errors.New("deposit cancel reason is required")
)
