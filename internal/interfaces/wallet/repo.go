...
type RepoWalletInterface interface {
	...
	CreatePaymentGatewayDeposit(ctx context.Context, deposit domainwallet.DepositRequest) (domainwallet.DepositRequest, error)
	CreateManualTopup(ctx context.Context, deposit domainwallet.DepositRequest, description string) (domainwallet.DepositRequest, error)
	AdjustWallet(ctx context.Context, userID, direction, amount, description, createdBy string) (domainwallet.WalletTransaction, error)
